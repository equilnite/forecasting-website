...
In many cases, there’s some clear limit to growth, which means the first-order approximation has to stop eventually. As a more extreme example, [the number of compute-hours used in the largest AI experiments grew around 10x/year between 2012 and 2018](https://openai.com/blog/ai-and-compute/). This probably can’t continue for much more before matching the world’s total current hardware budget.
